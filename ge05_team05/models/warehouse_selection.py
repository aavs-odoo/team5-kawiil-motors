...
class WarehouseSelection(models.Model):
    ...
    location_state = fields.Selection(string="Select you State",selection=[('AL','Alabama'),('AK','Alaska'),('AZ','Arizona'),('AR','Arkansas'),
                                        ...
                                        ('WY','Wyoming')],copy=False,default='DF',ondelte='cascade')
